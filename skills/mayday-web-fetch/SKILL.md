---
name: mayday-web-fetch
description: Fetch URL → markdown / text / HTML via Mayday /v1/web/fetch using Ollama Cloud / Firecrawl / Jina Reader / Tavily Extract / Exa Contents. Use when the user wants to scrape a webpage, extract URL content, read article, or convert a URL to markdown.
---

# Mayday Router — Web Fetch
...
curl -X POST $NINEROUTER_URL/v1/web/fetch \
  ...
  -d '{"model":"jina-reader","url":"https://mayday.20c.org","format":"markdown"}'
```

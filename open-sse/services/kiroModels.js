 ...
 * API. They are mayday fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic mayday variant set for a single upstream Kiro model.
 *
 ...
 * into mayday variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
